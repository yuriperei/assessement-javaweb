...
<html>
    ...
    <body>
            ...
            <div class="col-form-label">
                ...
                <form class="form-signin" method="post" action="manterEditora">
                    <h3 class="form-signin-heading">Editora</h3>
                    <input type="text" name="id" value="${editora.id}" hidden>
                    <label for="inputNome" class="input-group">Nome da editora</label>
                    <input type="text" id="inputNome" class="form-control" name="nome" value="${editora.nome}" placeholder="Nome da editora" required autofocus>
